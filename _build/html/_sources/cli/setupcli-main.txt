...
STEP3: **変数名(N):** ``RESCALE_API_TOKEN`` と **変数値(V):** ``<`あなたが作成した | API Key`>`` を設定します。

(API の作成がまだであれば " :doc:`./setupcli-create-apikey` " をご参照ください)
